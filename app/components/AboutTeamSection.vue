...
const membersByLocale: Record<'fr' | 'en', Member[]> = {
  fr: [
    ...
    },
    {
      ...
      bioFull: [
        "Nielle façonne l'image et la voix de MEGA : positionnement, storytelling visuel et cohérence sur l'ensemble des points de contact digitaux.",
        "En UX/UI, elle place l'utilisateur au centre : recherche, prototypage et itérations pour des parcours simples, accessibles et alignés avec les objectifs business.",
        "Elle travaille en étroite collaboration avec les équipes produit et technique pour que chaque écran reflète à la fois l'identité de la marque et des usages réels.",
      ],
    },
    {
      nameKey: 'meserigne',
      ...
      bioFull: [
        "Meserigne pilote les choix d'architecture, les piles technologiques et les pratiques d'ingénierie pour des systèmes robustes, observables et maintenables.",
        "Il veille à la qualité du code, à l'automatisation des déploiements et à la réduction des risques opérationnels, du développement jusqu'à la production.",
        "Partenaire des équipes métiers et design, il traduit les besoins en solutions techniques réalisables, évolutives et sécurisées sur le long terme.",
      ],
    },
  ],
  en: [
    ...
    },
    {
      ...
      name: 'Nielle Pascale OWENDE OGOWET',
      role: 'CMO - UX/UI Designer',
      bio: 'Brand and user experience: she shapes MEGA’s identity and designs interfaces that are useful, clear, and memorable.',
      bioFull: [
        'Nielle defines MEGA’s brand expression: positioning, visual storytelling, and consistency across digital touchpoints.',
        'In UX/UI she keeps users first—research, prototyping, and iteration for flows that are simple, accessible, and tied to business goals.',
        'She works closely with product and engineering so every screen reflects both brand identity and real-world usage.',
      ],
    },
    {
      nameKey: 'meserigne',
      name: 'Meserigne Ndiaye',
      role: 'CTO',
      bio: 'Architecture and engineering delivery: he ensures scalability, code quality, and reliable releases for digital solutions.',
      bioFull: [
        'Meserigne guides architecture, stack choices, and engineering practices for systems that are robust, observable, and maintainable.',
        'He focuses on code quality, deployment automation, and operational risk—from development through production.',
        'Working with business and design, he turns requirements into technical solutions that scale and stay secure over time.',
      ],
    },
  ],
}
